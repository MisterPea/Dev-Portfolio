          ...
          <ul>
            ...
            >
              <div className='text-side'>
                ...
                <p>Fine-art portfolio and additional content manager, built with NextJS.</p>
                <p className='extra-text'>A CMS and portfolio, both built on NextJS&#39;s SSR framework. The CMS allows the user
                  to upload, crop, tag, and organize files. The portfolio is built off of a JSON file generated by the CMS, which makes it easily updatable.</p>
                <div className='wares-button-wrapper'>
                  <h3 tabIndex={0} role="button" data-link="cms.perryangelora.com">
                    Launch the CMS
                    <div className='wares-arrow-icon'><MdArrowForward /></div>
                  </h3>
                  <h3 tabIndex={0} role="button">
                  ...
                  <h3 tabIndex={0} role="button" data-link="github.com/MisterPea/Art-Portfolio" >
                    View on GitHub
                    <div className='wares-arrow-icon'><MdArrowForward /></div>
                  </h3>
                </div>
              ...
              <div className='image-side'>
                <div className='pa-image'>
                  <img src={'/perryangelora.com.png'} alt="perryangelora.com" />
                </div>
              </div>
            </li>
            <li
            ...
            >
              <div className='text-side'>
                ...
                <p>This very site, which you are looking at, right now.</p>
